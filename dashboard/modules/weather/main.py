...
def render():
    ...
    if now - _last_update >= 5 * 60:
        ...
        for i, data in enumerate(icons_data):
            ...
            screen.add_image(os.path.join(script_directory, "icons", icon),(x_pos, 0.78),(0.095, 0.13),invert=invert,color_black=True)
...
def weather_to_icon(text):
    ...
    if "sunny" in t or "clear" in t: return True, "thunderstorms.png"#"sunny.png"
